...
export declare namespace SpecialRenderers {
    ...
    function bannerRenderer(color: string): (atlas: TextureAtlasProvider) => Mesh;
    function wallBannerRenderer(color: string): (atlas: TextureAtlasProvider) => Mesh;
    ...
    function getBlockMesh(block: BlockState, atlas: TextureAtlasProvider, cull: Cull): Mesh;
}
